...
**Метод структурно-параметрического анализа технических 2D-документов с интеграцией геометрических характеристик для обработки предметно-ориентированными агентами**
